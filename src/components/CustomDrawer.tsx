...
const CustomDrawer = (props: DrawerProps) => {
  ...
  const containerStyle = {backgroundColor: 'white', padding: 8 ,borderRadius:20,width:320,marginLeft:'auto',marginRight:'auto' };
  ...
  return (
    <View style={{flex: 1}}>
      <DrawerContentScrollView
        ...
        <Text className='text-2xl text-[#231E60] font-bold'>KMC </Text><Text className='text-[#231E60] font-bold'> WARD 111</Text>
        </View>
      ...
      <Portal>
        <Modal visible={visible} onDismiss={hideModal} contentContainerStyle={containerStyle}>
          ...
          <Text className='p-2 text-[#231E60] font-bold text-base'>Are you sure you want to log out?</Text>
          <TouchableOpacity onPress={hideModal}><Text className='text-[#231E60]'><Icon name="close" size={18} /></Text></TouchableOpacity>
          </View>

          <View className='p-5 mt-5'>
          <TouchableOpacity><View className='bg-[#231E60] p-3 rounded-lg'><Text className='text-white ml-auto mr-auto text-base'>Yes</Text></View></TouchableOpacity>
          <TouchableOpacity onPress={()=>{}} style={{paddingVertical: 15}}>
          <View className='border border-[#231E60] rounded-lg p-2'>
            <Text className='text-[#231E60] ml-auto mr-auto text-base'>No</Text>
          </View>
        ...
        <View style={{backgroundColor: '#fff', paddingTop: 10}} className='px-5 flex flex-col justify-between'>
